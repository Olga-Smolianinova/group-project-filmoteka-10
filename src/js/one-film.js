import templateListfilm from '../templates/one-film.hbs';
import footer from '../html/footer.html';
import header from '../html/header.html';
refs.onefilm.insertAdjacentHTML('afterend', markupone-film)
function createCardFunc(imgPath, filmTitle, movieId) {
  const markup = templateListfilm(imgPath, filmTitle, movieId);
}
